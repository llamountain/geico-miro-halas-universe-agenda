...
async function start() {
  ...
  function render() {
    ...
    results.textContent = `${visible.length} ${visible.length === 1 ? "session" : "sessions"} \u2022 ${state.mode === "primary" ? "sequenced executive itinerary" : "alternatives may overlap; follow replacement notes"}`;
